...
export const RC_API_KEY_IOS = 'appl_CdCTpjYdIieNLozIEtVAkNiwKzi'; // public SDK key (safe to ship)
export const RC_API_KEY_ANDROID = 'goog_yTGjyZPZtkzVDUcMGQfaCtYrhLp'; // starts with "goog_"
